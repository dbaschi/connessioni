...
var solutions=0;
var lifes =4;
function Solve(matchedButtons,cleanClass,categories, document, solutions, colorArray){
    var text=[];
    ...
    matchedButtons.forEach(btn => {
        ...
        if (solutions===0){
          ...
          document.getElementById("one").innerHTML = cleanClass+ "<br>"+ text;
        }
        if (solutions===1){
          ...
          document.getElementById("two").innerHTML = cleanClass+ "<br>"+ text;
        }
        if (solutions===2){
          ...
          document.getElementById("three").innerHTML = cleanClass+ "<br>"+ text;
        ...
        if (solutions===3){
          ...
          document.getElementById("four").innerHTML = cleanClass+ "<br>"+ text;
        }
...
const colorArray = ["#d2cc11","#11d211", "#5461ee","#bd10d0"];
for (let i = 1; i <= 16; i++) {
